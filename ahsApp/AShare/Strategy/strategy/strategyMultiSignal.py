...
from ahsApp.AShare.Strategy.Template import (TargetPosTemplate, 
                                                     AShSignal,
                                                     BarGenerator, 
                                                     ArrayManager)
...
class MultiSignalStrategy(TargetPosTemplate):
    ...
    def __init__(self, ashEngine, setting):
        """Constructor"""
        super(MultiSignalStrategy, self).__init__(ashEngine, setting)
