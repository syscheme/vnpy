...
class AShTemplate(object):
    ...
    def cancelOrder(self, vtOrderID):
        ...
        if STOPORDERPREFIX in vtOrderID:
            self.ashEngine.cancelStopOrder(vtOrderID)
        else:
            self.ashEngine.cancelOrder(vtOrderID)
            
    #----------------------------------------------------------------------
    def cancelAll(self):
        """全部撤单"""
        self.ashEngine.cancelAll(self.name)
    
    #----------------------------------------------------------------------
    def insertTick(self, tick):
        """向数据库中插入tick数据"""
        self.ashEngine.insertData(self.tickDbName, self.vtSymbol, tick)
    
    #----------------------------------------------------------------------
    def insertBar(self, bar):
        """向数据库中插入bar数据"""
        self.ashEngine.insertData(self.barDbName, self.vtSymbol, bar)
        
    #----------------------------------------------------------------------
    def loadTick(self, days):
        """读取tick数据"""
        return self.ashEngine.loadTick(self.tickDbName, self.vtSymbol, days)
    ...
    def putEvent(self):
        """发出策略状态变化事件"""
        self.ashEngine.putStrategyEvent(self.name)
        
    #----------------------------------------------------------------------
    def getEngineType(self):
        """查询当前运行的环境"""
        return self.ashEngine.engineType
    
    #----------------------------------------------------------------------
    def saveSyncData(self):
        """保存同步数据到数据库"""
        if self.trading:
            self.ashEngine.saveSyncData(self)
    
    #----------------------------------------------------------------------
    def getPriceTick(self):
        """查询最小价格变动"""
        return self.ashEngine.getPriceTick(self)
...
class TargetPosTemplate(AShTemplate):
    ...
    def __init__(self, ashEngine, setting):
        """Constructor"""
        super(TargetPosTemplate, self).__init__(ashEngine, setting)
